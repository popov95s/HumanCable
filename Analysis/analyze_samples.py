            ...
            for bit in line:
                if bit.isdigit():
                    ...
                    if globals.openSeq is False:
                        ...
                        if check_opening_sequence(opening_sequence_checker)==True:
                        ...
                        data.insert_new((np.array(list(bit)).astype(np.int)))
                        if check_closing_sequence(closing_sequence_checker)== True  or has_invalid(opening_sequence_checker)==True:
