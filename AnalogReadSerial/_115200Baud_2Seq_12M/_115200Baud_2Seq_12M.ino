...
*/
/* Baud Rate 115200; 2 byte opening closing sequence; 13 byte message */

int asciiDecimal[] = {255, 255, 72, 101, 108, 108, 111, 32, 87, 111, 114, 108, 100, 10, 0, 0};
