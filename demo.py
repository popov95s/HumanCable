...
serial_port = serial.Serial('/dev/cu.usbserial-A5027IRK', baudrate=int(sys.argv[2]), timeout=1)
serial_port.flush()
        ...
        for i in range(0,1000):
            ...
            while globals.openSeq is True:
                ...
                if values and len(list(values))==8:
                    ...
                    #print(''.join(message))
                    if "Hello, I'm Van Tran, a Computer Science major at SMU !" in (''.join(message)):
                        print ("Hello, I'm Van Tran, a Computer Science major at SMU !")
                        exit(0)
